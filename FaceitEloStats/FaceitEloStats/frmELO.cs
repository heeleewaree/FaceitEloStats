    ...
    public partial class frmELO : Form
    {
        ...
        public void PaintFunction()
        {
            try
            {
                ...
                if (lvl != 10)
                    gr.DrawString(Convert.ToString(lvl), new Font("Arial", 55), skillLevelBrush, new Point(textX + 37, Y - 200 + 30 + correction));
                else
                    gr.DrawString(Convert.ToString(lvl), new Font("Arial", 55), skillLevelBrush, new Point(textX + 37 - 23, Y - 200 + 30 + correction));
